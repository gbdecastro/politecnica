...
class SessionGuard implements StatefulGuard, SupportsBasicAuth
{
     ...
     */
    public function basic($field = 'tx_email', $extraConditions = [])
    {
        if ($this->check()) {
            return;
        }
     ...
     * @return \Symfony\Component\HttpFoundation\Response|null
     */
    public function onceBasic($field = 'tx_email', $extraConditions = [])
    {
    ...
    {
        return [$field => $request->getUser(), 'tx_password' => $request->getPassword()];
    }
