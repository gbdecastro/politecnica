                    ...
                    <table id="table_funcionarios" class="table table-striped" data-page-length="25">
                        ...
                        <tbody>
                            <tr v-for="(funcionario,key) in funcionarios">
                                ...
                                <td>
                                    <button class="btn btn-default" data-toggle="modal" v-bind:data-tx_funcionario="funcionario.tx_name" v-bind:data-id_funcionario="funcionario.id_usuario" data-target="#modal_calendario">
